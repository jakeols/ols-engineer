...
const BooksPage = () => (
  <Layout>
    ...
    <ul>
      ...
      <li>the atlas paradox - olivie blake</li>
      <li>we begin at the end - chris whitaker </li>
      <li>city of dragons - robin hobb</li>
      <li>the blood of dragons - robin hobb</li>
      <li>beartown - federick bachman (sp) </li>
      <li>shuggie bain - douglas stuart</li>
      <li>mrs demeanor - elinor lipman </li>
      <li>flashback - dan simmons </li>
      <li>a curious beginning - deanna raybourn</li>
      <li>the great believers - rebecca makkai </li>
      <li>a perilous undertaking- deanna raybourn</li>
      <li>the lives of puppets - tj klune </li>
      <li>the death of vivek oji - akwaeke emezi </li>
      <li>tress of the emerald sea - brandon sanderson </li>
      <li>the storied life of A.J. fickry</li>
      <li>blessings - anna quindlen </li>
      <li>divine rivals - rebecca ross </li>
      <li>mistborn secret history - brandon sanderson </li>
      <li>the 7 1/2 deaths of evelyn hardcastle - stuart turton </li>
      <li> the mostly true story of tanner & louise - colleen oakley </li>
      <li> the lincoln highway - amor towles</li>
      ...
      <li>prince of thorns - mark lawrence</li>
      <li>king of thorns - mark lawrence</li>
      <li>emperor of thorns - mark lawrence</li>
    ...
    <ul>
      ...
      <li>
        crooked kingdom - leigh bardugo <i>(sensing a pattern?)</i>
      </li>
      ...
      <li>the well of ascension - brandon sanderson</li>
      <li>spindle splintered - alix harrow</li>
    ...
    <ul>
      ...
      <li>what should be wild - julia fine</li>
      <li>the spellman files - lisa lutz</li>
      <li>borne - jeff vandermeer (auhtor of southern reach trilogy)</li>
      <li>less - andrew greer</li>
      <li>the swallows - lisa lutz</li>
      <li>the woman in the window - aj finn</li>
